...
public extension TrivialMesh {
    ...
    static func tetrahedron() -> TrivialMesh {
        ...
        // 4 faces x 3 vertices = 12 vertices (duplicated for proper normals/MSs)
        let positions: [SIMD3<Float>] = [
    ...
    static func octahedron() -> TrivialMesh {
        ...
        // 8 faces x 3 vertices = 24 vertices (duplicated for proper normals/MSs)
        let positions: [SIMD3<Float>] = [
            // Top pyramid - 4 faces
            // Front face
            [0, r, 0],     // 0: top
        ...
        // MS coordinates for each triangular face
        let textureCoordinates: [SIMD2<Float>] = [
            // Top pyramid faces
            [0.5, 1], [0, 0], [1, 0],  // Front
            [0.5, 1], [0, 0], [1, 0],  // Right
    ...
    static func icosahedron() -> TrivialMesh {
        ...
        for (faceIndex, face) in faceIndices.enumerated() {
            ...
            // Simple MS mapping for triangular faces
    ...
    static func dodecahedron() -> TrivialMesh {
        ...
        for face in faceIndices {
            ...
            for i in 0..<5 {
                ...
                // MS coordinates for pentagon vertices
    ...
    static func sphere(latitudeSegments: Int = 16, longitudeSegments: Int = 32) -> TrivialMesh {
        // MS sphere - easiest to implement
    ...
    static func icoSphere(subdivisions: Int = 2) -> TrivialMesh {
        ...
        for (faceIndex, face) in faces.enumerated() {
            for vertexIndex in face {
                ...
                // Calculate MS coordinates from spherical coordinates
